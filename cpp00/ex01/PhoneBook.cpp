...
void PhoneBook::addContact()
{
	...
	{
		std::cout << "First name can only contain letters." << std::endl;
		return;
	}
	...
	if (input.find_first_not_of("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ") != std::string::npos)
	{
		std::cout << "Last name can only contain letters." << std::endl;
		return;
	}
	...
	{
		std::cout << "Darkest secret can only contain letters, digits, and spaces." << std::endl;
		return;
	}
