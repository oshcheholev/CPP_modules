...
public:
	...
	// void setHitPoints(unsigned int hitPoints); // Setter for hit points
	// void setEnergyPoints(unsigned int energyPoints); // Setter for energy points
	// void setAttackDamage(unsigned int attackDamage); // Setter for attack damage
